...
export const snippets_1_36_0: SnippetItem[] = [
    ...
    },
    {
        ...
        "description": "- purestorage.flasharray.purefa_workload",
        "body": "\n- name: Create a workload using an exisitng preset using the recommended target and\n    connect to host myhost\n  purestorage.flasharray.purefa_workload:\n    name: foo\n    preset: bar\n    host: myhost\n    recommendation: true\n    fa_url: 10.10.10.2\n    api_token: e31060a7-21fc-e277-6240-25983c6c4592\n"
    },
    {
        "label": "Add volumes to workload foo based on volume configuration fin and connect to host myhost",
        "description": "- purestorage.flasharray.purefa_workload",
        "body": "\n- name: Add volumes to workload foo based on volume configuration fin and connect\n    to host myhost\n  purestorage.flasharray.purefa_workload:\n    name: foo\n    preset: bar\n    volume_configuration: fin\n    volume_count: 3\n    host: myhost\n    state: expand\n    fa_url: 10.10.10.2\n    api_token: e31060a7-21fc-e277-6240-25983c6c4592\n"
    },
    {
