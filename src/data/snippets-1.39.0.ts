...
export const snippets_1_39_0: SnippetItem[] = [
    ...
    },
    {
        ...
        "description": "- purestorage.flasharray.purefa_dirsnap",
        "body": "- name: Update retention time for a snapshot foo:bar.client.test\n  purestorage.flasharray.purefa_dirsnap:\n    name: foo\n    filesystem: bar\n    client: client\n    suffix: test\n    keep_for: 300\n    fa_url: 10.10.10.2\n    api_token: e31060a7-21fc-e277-6240-25983c6c4592\n"
    },
    {
        "label": "Delete snapshot foo:bar.client.test",
        "description": "- purestorage.flasharray.purefa_dirsnap",
        "body": "- name: Delete snapshot foo:bar.client.test\n  purestorage.flasharray.purefa_dirsnap:\n    name: foo\n    filesystem: bar\n    client: client\n    suffix: test\n    state: absent\n    fa_url: 10.10.10.2\n    api_token: e31060a7-21fc-e277-6240-25983c6c4592\n"
    },
    {
        "label": "Recover deleted snapshot foo:bar.client.test",
        "description": "- purestorage.flasharray.purefa_dirsnap",
        "body": "- name: Recover deleted snapshot foo:bar.client.test\n  purestorage.flasharray.purefa_dirsnap:\n    name: foo\n    filesystem: bar\n    client: client\n    suffix: test\n    fa_url: 10.10.10.2\n    api_token: e31060a7-21fc-e277-6240-25983c6c4592\n"
    },
    {
        "label": "Delete and eradicate snapshot foo:bar.client.test",
        "description": "- purestorage.flasharray.purefa_dirsnap",
        "body": "- name: Delete and eradicate snapshot foo:bar.client.test\n  purestorage.flasharray.purefa_dirsnap:\n    name: foo\n    filesystem: bar\n    client: client\n    suffix: test\n    state: absent\n    eradicate: true\n    fa_url: 10.10.10.2\n    api_token: e31060a7-21fc-e277-6240-25983c6c4592\n"
    },
    {
        "label": "Eradicate deleted snapshot foo:bar.client.test",
        "description": "- purestorage.flasharray.purefa_dirsnap",
        "body": "- name: Eradicate deleted snapshot foo:bar.client.test\n  purestorage.flasharray.purefa_dirsnap:\n    name: foo\n    filesystem: bar\n    client: client\n    suffix: test\n    eradicate: true\n    state: absent\n    fa_url: 10.10.10.2\n    api_token: e31060a7-21fc-e277-6240-25983c6c4592\n"
    },
    {
    ...
    },
    {
        ...
        "description": "- purestorage.flasharray.purefa_dsrole",
        "body": "- name: Create observability directory service role with readonly policy\n  purestorage.flasharray.purefa_dsrole:\n    name: observability\n    role: readonly\n    group_base: OU=PureGroups,OU=ReadOnly\n    group: o11y\n    fa_url: 10.10.10.2\n    api_token: e31060a7-21fc-e277-6240-25983c6c4592\n"
    },
    {
        "label": "Update system-defined array_admin directory service role",
        "description": "- purestorage.flasharray.purefa_dsrole",
        "body": "- name: Update system-defined array_admin directory service role\n  purestorage.flasharray.purefa_dsrole:\n    role: array_admin\n    group_base: OU=PureGroups,OU=SANManagers\n    group: pureadmins\n    fa_url: 10.10.10.2\n    api_token: e31060a7-21fc-e277-6240-25983c6c4592\n"
    },
    {
    ...
    },
    {
        ...
        "description": "- purestorage.flasharray.purefa_pgsnap",
        "body": "- name: Delete and eradicate protection group snapshot named foo.snap\n  purestorage.flasharray.purefa_pgsnap:\n    name: foo\n    suffix: snap\n    eradicate: true\n    fa_url: 10.10.10.2\n    api_token: e31060a7-21fc-e277-6240-25983c6c4592\n    state: absent\n"
    },
    {
        "label": "Restore volume data from local protection group snapshot named foo.snap to volume data2",
        "description": "- purestorage.flasharray.purefa_pgsnap",
        "body": "- name: Restore volume data from local protection group snapshot named foo.snap to\n    volume data2\n  purestorage.flasharray.purefa_pgsnap:\n    name: foo\n    suffix: snap\n    restore: data\n    target: data2\n    overwrite: true\n    with_default_protection: false\n    fa_url: 10.10.10.2\n    api_token: e31060a7-21fc-e277-6240-25983c6c4592\n    state: copy\n"
    },
    {
        "label": "Restore remote protection group snapshot arrayA:pgname.snap.data to local copy",
        "description": "- purestorage.flasharray.purefa_pgsnap",
        "body": "- name: Restore remote protection group snapshot arrayA:pgname.snap.data to local\n    copy\n  purestorage.flasharray.purefa_pgsnap:\n    name: arrayA:pgname\n    suffix: snap\n    restore: data\n    fa_url: 10.10.10.2\n    api_token: e31060a7-21fc-e277-6240-25983c6c4592\n    state: copy\n"
    },
    {
    ...
    },
    {
        ...
        "description": "- purestorage.flasharray.purefa_pgsnap",
        "body": "- name: Delete and eradicate snapshot named foo.snap on offload target bar from arrayA\n  purestorage.flasharray.purefa_pgsnap:\n    name: arrayA:foo\n    suffix: snap\n    offload: bar\n    eradicate: true\n    fa_url: 10.10.10.2\n    api_token: e31060a7-21fc-e277-6240-25983c6c4592\n    state: absent\n"
    },
    {
    ...
    },
    {
        ...
        "description": "- purestorage.flasharray.purefa_volume",
        "body": "- name: Create new volume named foo in protection group pg1 (this cannot be used with\n    context)\n  purestorage.flasharray.purefa_volume:\n    name: foo\n    pgroup: pg1\n    size: 1T\n    fa_url: 10.10.10.2\n    api_token: e31060a7-21fc-e277-6240-25983c6c4592\n    state: present\n"
    },
    {
        "label": "Create 10 volumes with index starting at 10 but padded with 3 digits",
        "description": "- purestorage.flasharray.purefa_volume",
        "body": "- name: Create 10 volumes with index starting at 10 but padded with 3 digits\n  purestorage.flasharray.purefa_volume:\n    name: foo\n    size: 1T\n    suffix: bar\n    count: 10\n    start: 10\n    digits: 3\n    fa_url: 10.10.10.2\n    api_token: e31060a7-21fc-e277-6240-25983c6c4592\n    state: present\n"
    },
    {
        "label": "Extend the size of an existing volume named foo",
        "description": "- purestorage.flasharray.purefa_volume",
        "body": "- name: Extend the size of an existing volume named foo\n  purestorage.flasharray.purefa_volume:\n    name: foo\n    size: 2T\n    fa_url: 10.10.10.2\n    api_token: e31060a7-21fc-e277-6240-25983c6c4592\n    state: present\n"
    },
    {
        "label": "Delete and eradicate volume named foo",
        "description": "- purestorage.flasharray.purefa_volume",
        "body": "- name: Delete and eradicate volume named foo\n  purestorage.flasharray.purefa_volume:\n    name: foo\n    eradicate: true\n    fa_url: 10.10.10.2\n    api_token: e31060a7-21fc-e277-6240-25983c6c4592\n    state: absent\n"
    },
    {
        "label": "Create clone of volume bar named foo",
        "description": "- purestorage.flasharray.purefa_volume",
        "body": "- name: Create clone of volume bar named foo\n  purestorage.flasharray.purefa_volume:\n    name: foo\n    target: bar\n    fa_url: 10.10.10.2\n    api_token: e31060a7-21fc-e277-6240-25983c6c4592\n    state: present\n"
    },
    {
        "label": "Overwrite volume bar with volume foo",
        "description": "- purestorage.flasharray.purefa_volume",
        "body": "- name: Overwrite volume bar with volume foo\n  purestorage.flasharray.purefa_volume:\n    name: foo\n    target: bar\n    overwrite: true\n    fa_url: 10.10.10.2\n    api_token: e31060a7-21fc-e277-6240-25983c6c4592\n    state: present\n"
    },
    {
        "label": "Clear volume QoS from volume foo",
        "description": "- purestorage.flasharray.purefa_volume",
        "body": "- name: Clear volume QoS from volume foo\n  purestorage.flasharray.purefa_volume:\n    name: foo\n    bw_qos: 0\n    iops_qos: 0\n    fa_url: 10.10.10.2\n    api_token: e31060a7-21fc-e277-6240-25983c6c4592\n    state: present\n"
    },
    {
        "label": "Move local volume foo from local array to pod bar",
        "description": "- purestorage.flasharray.purefa_volume",
        "body": "- name: Move local volume foo from local array to pod bar\n  purestorage.flasharray.purefa_volume:\n    name: foo\n    move: bar\n    fa_url: 10.10.10.2\n    api_token: e31060a7-21fc-e277-6240-25983c6c4592\n"
    },
    {
        "label": "Move volume foo in pod bar to local array",
        "description": "- purestorage.flasharray.purefa_volume",
        "body": "- name: Move volume foo in pod bar to local array\n  purestorage.flasharray.purefa_volume:\n    name: bar::foo\n    move: local\n    fa_url: 10.10.10.2\n    api_token: e31060a7-21fc-e277-6240-25983c6c4592\n"
    },
    {
        "label": "Move volume foo in pod bar to vgroup fin",
        "description": "- purestorage.flasharray.purefa_volume",
        "body": "- name: Move volume foo in pod bar to vgroup fin\n  purestorage.flasharray.purefa_volume:\n    name: bar::foo\n    move: fin\n    fa_url: 10.10.10.2\n    api_token: e31060a7-21fc-e277-6240-25983c6c4592\n"
    },
    {
